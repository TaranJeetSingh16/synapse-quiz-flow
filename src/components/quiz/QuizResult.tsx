...
const QuizResult = () => {
  const { correctAnswers, answeredQuestions, xpPoints, selectedCategory, resetQuiz, startQuiz } = useQuiz();
            ...
            <div className="bg-secondary/30 p-4 rounded-xl">
              ...
              <div className="space-y-2">
                <div className="flex items-center">
                  <Badge variant="outline" className="mr-2 bg-primary/10 border-primary/20">1</Badge>
                  <span className="text-sm">{score >= 70 ? 'Try a more difficult category' : 'Retry this quiz to improve your score'}</span>
                </div>
                <div className="flex items-center">
                  <Badge variant="outline" className="mr-2 bg-primary/10 border-primary/20">2</Badge>
                  <span className="text-sm">Check detailed analytics in your dashboard</span>
                </div>
                <div className="flex items-center">
                  <Badge variant="outline" className="mr-2 bg-primary/10 border-primary/20">3</Badge>
                  <span className="text-sm">Challenge a friend to beat your score</span>
                </div>
              </div>
            </div>
          </div>
